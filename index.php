...
<body>
    ...
    <main id="main">
        ...
        <section class="bioWrap" style="margin-top: 5px; !important">
            <?php echo $verifyShow; ?>
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 card" style="background-color: #f8f9fa87 !important;padding-top:10px;height: 100vh !important;">
                        <ul style="list-style: none;">
                <li class="active" style="margin-right:10px;"><a href="index.php" style="" ><h5 class="ind-main"><i class="fa fa-home" aria-hidden="true"></i><span class="pl-0.5">Home</span></h5></a></li>
                <li style="margin-right:10px;">
                    <div class="dropdown open ">
                        <div class=" dropdown-toggle" id="dropdownMenu4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
                            <a href="#services" class="msg-notification-container" style="position:relative;"><h5 class="ind-main">
                                <i class="fa fa-envelope-o" aria-hidden="true"></i><span class="noti-count-wrap" ><?php if(count($loadFromPost->msgNotificationCount($userid)) == '0'){}else{ echo '<div class="msg-noti-count" style="background-color: #dc3545;;">'.count($loadFromPost->msgNotificationCount($userid)).'</div>'; } ?></span><span class="pl-0.5">Message</span></h5></a>
                        </div>
                ...
                <li>
                    <div class="dropdown open ">
                        <div class=" dropdown-toggle" id="dropdownMenu4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
                            <a href="#services" class="notification-container" style="position:relative;"><h5 class="ind-main">
                                <i class="fa fa-bell-o" aria-hidden="true"></i><span class="noti-count-wrap"><?php if(count($loadFromPost->notificationCount($userid)) == '0'){}else{ echo '<div class="noti-count">'.count($loadFromPost->notificationCount($userid)).'</div>'; } ?></span><span class="pl-0.5">Notification</span></h5></a>
                        </div>
                 ...
                 <li class="active" style="margin-right:10px;"><a href="profile.php" style="" ><h5 class="ind-main"><i class="fa fa-user-o" aria-hidden="true"></i><span class="pl-0.5">Profile</span></h5></a></li>
                 <li>
                     <div class="user-act-wrap d-flex justify-content-between align-items-center" style="    padding: 5px 10px;background: azure;border-radius: 35px;margin-bottom: 20px;">
                         <div class="d-flex justify-content-between align-items-center">
                             <div class="user-act-img">
                                 <img style="height:40px; width:40px; border-radius:50%;" src="<?php echo BASE_URL.$userData->profilePic; ?>" alt="" />
                             </div>
                             <div class="user-act-info " style="margin-left: 10px;font-size: 14px;">
                                 <div class="user-act-info-name" style="font-weight:600;"><?php echo $userData->full_name; ?></div>
                                 <div class="user-act-info-username text-secondary">@<?php echo $userData->username; ?></div>
                                 
                             </div>
                         </div>
                         <div class="user-act-action">
                             <div class="dropdown open ">
                                <div class=" dropdown-toggle" id="dropdownMenu4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
                        ...
                        <div class="dropdown-menu noti-wrap" style="box-shadow: 0px 0px 5px grey;">
                            ...
                            <a data-toggle="modal" data-target="#postSchedule" class="dropdown-item d-flex justify-content-start align-items-center postSchedule" href="" style="padding: 8px 20px 12px 18px !important;">
                                
                                <div class="noti-text" style="margin-left:5px;">
                                   <i style="margin-right:5px" class="fa fa-calendar" aria-hidden="true"></i>Schedule Post
                                </div>
                            </a>
                           <a class="dropdown-item d-flex justify-content-start align-items-center" href="logout.php" style="padding: 8px 20px 12px 18px !important;">
                                
                                <div class="noti-text" style="margin-left:5px;">
                                    <i style="margin-right:5px" class="fa fa-sign-out" aria-hidden="true"></i>Logout <span style="color:gray;">@<?php echo $userData->username; ?></span>
                                </div>
                            </a>
                ...
                <li>
                    <div class="get-started2"><div data-toggle="modal" data-target="#createTweet">Tweet</div></div>
                </li>


            </ul>
            <div class="createPage" style="display:flex;justify-content: flex-start;align-items: center;font-size: 16px;margin-left: 40px;margin-top: 35px; cursor:pointer;" data-toggle="modal" data-target="#createPage">
                <i class="fa fa-file-text-o" aria-hidden="true"></i><span style ="margin-left: 10px;">Create Propage</span>
                </div>
            

                    </div>
                    <div class=" col-lg-6 border h-50 bg-white pl-3 card all-post-holder" style="height: 100vh !important;overflow-y: scroll;">
                    ...
                    <div class="col-lg-3 bg-white card" style="background-color: #f8f9fa87 !important;height: 100vh !important;">
                        <div class="dropdown open">
        ...
        <div class="modal" id="createPage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="width: 115%;">
                    <div class="modal-header">
                        <h4 class="modal-title font-weight-bold" id="exampleModalLabel">Create Propage</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                    <div class="create-page-cat-wrap">
                        <h5>Select Category</h5>
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="card">
                              <div class="card-body my-align-center page-cat" data-cat="bus-cat" style="flex-direction: column;">
                                <img src="assets/img/small-business.png" style="width:150px;"  alt="">
                                <a href="#" class="btn border border-info">Business</a>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="card">
                              <div class="card-body my-align-center page-cat" data-cat="brand-cat" style="flex-direction: column;">
                                <img src="assets/img/branding.png" style="width:150px;" alt="">
                                <a href="#" class="btn border border-info">Brand</a>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="row" style="margin-top: 15px;">
                          <div class="col-sm-6">
                            <div class="card">
                              <div class="card-body my-align-center page-cat" data-cat="community-cat" style="flex-direction: column;">
                                <img src="assets/img/community.png" style="width:150px;"  alt="">
                                <a href="#" class="btn border border-info">Community</a>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="card">
                              <div class="card-body my-align-center page-cat" data-cat="pub-cat" style="flex-direction: column;">
                                <img src="assets/img/public figures.png" style="width:150px;" alt="">
                                <a href="#" class="btn border border-info">Public Figure</a>
                              </div>
                            </div>
                          </div>
                        </div>
                        <input type="hidden" class="page-cat-val"  />
                    </div>  
                    <div class="create-page-name" style="display:none;">
                        <div class="my-align-center mb-1 text-secondary page-back" style="justify-content: flex-start;cursor:pointer;display: inline-block;"><i class="fa fa-long-arrow-left" aria-hidden="true"></i><span class="ml-1">Back</span></div>
                        <div class="form-group">
                            <label for="formGroupExampleInput">Page Name</label>
                            <input type="text" class="form-control page-name-val" placeholder="">
                         </div>
                         
                        <div class="modal-footer" style="border-top: none;">
                        <button class="btn btn-primary" id="create-page-button">Create Page</button>
                    </div>
                    </div>
                    </div>
...
-->
   ...
   <div id="calendar"></div>
                        ...
                        <?php $schList = $loadFromPost->postScheduleList($userid);
    ...
    <div class="col-10 post-wrap" data-postid="<?php echo $sch->post_id; ?>" style="padding-left:25px;margin-left: -36px;">
        ...
        <?php if(empty($sch->postVideo)){ 
               ...
               $sharedVidLink = $loadFromPost->sharedVidLink($vidCode);
                    ...
                    <div class="modal-body">
                        <form onsubmit="return false" method="post" action="core/ajax/postTweet.php" enctype="multipart/form-data" id="video-upload-form" class="edit-image-upload">
                            ...
                            <div class="main-textarea-wrap">
                                ...
                                <textarea name="" id="tweetTextarea" cols="65" rows="5" placeholder="What's going on your mind?"></textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            //********************** 
             //Page schedule start
             //********************** 
             $(document).on('click','.page-cat', function(){
                 var pageCat = $(this).data('cat');
                 $('.page-cat-val').val(pageCat);
                 $('.create-page-cat-wrap').hide();
                 $('.create-page-name').show(); 
             })
             $(document).on('click','.page-back', function(){
                 
                 $('.create-page-cat-wrap').show();
                 $('.create-page-name').hide(); 
             })
             $(document).on('click','#create-page-button', function(){
                 var pageCat = $('.page-cat-val').val();
                 var pageName = $('.page-name-val').val();
                 $.post('https://paapil.com/core/ajax/createPage.php', {
                     pageCat: pageCat,
                     pageName: pageName
                 }, function(data){
                     window.location.href = "https://paapil.com/page.php?pageid="+data+"";
                 })
             })
    ...
    // }, 1000); 
        ...
        $('.edit-image-upload2').ajaxSubmit({
            ...
            $(document).on('click', '#comment-upload-save', function() {
             ...
             //********************** 
             //profile cover and post image show start
             //********************** 
            ...
            $(document).on('click', '.get-started2', function() {
