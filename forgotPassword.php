...
<!DOCTYPE html>
    ...
    <body>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="height: 50vh;display: flex;justify-content: center;">
                            <div class="verify-wrap" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
                                ...
                                <h4 style="color:black;font-weight:600;">Write your Email</h4>
                                
                                <div class="verify-input pb-2">
                                    <input type="email" id="email-text" class="form-control" placeholder="Username" style="text-align: center;">
                                     <div class="resend-code">
                                    <p class="text-primary" style="cursor:pointer;font-size:12px;display:none;">Send password rest link</p>
                                </div>
                                </div>
                                <div class="verify-buttoon">
                                    <button class="btn btn-primary forgotPass-btn">Send password rest link</button>
                                </div>
        ...
        <script>
            $(function(){
                $(document).on('click', 'button.btn.btn-primary.forgotPass-btn', function(){
                    var emailText = $("input#email-text").val();
                  
                    var testEmail = /^[A-Z0-9._%+-]+@([A-Z0-9-]+\.)+[A-Z]{2,4}$/i;
                            if (testEmail.test(emailText))
                                
                    
                    
                    
                      $.post('https://paapil.com/core/ajax/forgotPassword.php', {
                        ...
                        if (data.trim() !== '') {
                            ...
                            $('.resend-code-sent').show().html('Password reset link sent successfully.');
                            //  setTimeout(function() {
                            ...
                            // }, 3000); 
                                 ...
                                 $('.verify-error').show().html("Incorrect email formate.");
                                 setTimeout(function() {
