...
<?php echo $verifyShow; ?>
            <div class="row position-relative show-cover" data-toggle="modal" data-target="#cover-show-modal" style="height:230px; overflow: hidden">
                <div class="cover-holder" style="height:100%; width:100%">
                    <div class="coverImageHolder">
                        <img class="w-100" src="<?php echo BASE_URL.$profileData->coverPic; ?>" />
            ...
            <div class='row follow-details d-flex justify-content-center align-items-center p-2' style="background-color:white">
                <div class="ml-5 followers-count d-flex flex-column  justify-content-center align-items-center mr-5"><span class="text-secondary">Tweets</span><span class="text-secondary font-weight-bold" style="font-size:20px"><?php echo $loadFromPost->postCount($profileId); ?></span></div>
            ...
            <div class="row position-relative">
                <div class="profile-holder position-absolute" style="bottom:-20px;left:13%">
                    <div class="profileImageHolder" style="height:200px;  width:200px; border-radius:50%">
                        <img class="w-100 show-profile" src="<?php echo BASE_URL.$profileData->profilePic; ?>" style="border-radius:50%;border:10px solid white;box-shadow:0px 0px 10px gray;height: 200px;width: 200px !important;" data-toggle="modal" data-target="#profile-show-modal" />
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 card" style="background-color: #f8f9fa87 !important;padding-top:10px;">
                        ...
                        <?php if(empty($profileData->website)){}else{ ?>
                        <div class="userWebsite text-primary"><span><i class="fa fa-link" aria-hidden="true"></i><span class="pl-1"><a href="<?php echo 'http://'.$profileData->website; ?>"><?php echo $profileData->website; ?></a></span></span>
                        </div>
                        <?php } ?>
                        <div class="area-join">
                            <?php if(empty($profileData->location)){}else{ ?>
                            <div class="userLiveIn text-primary"><span><i class="fa fa-location-arrow" aria-hidden="true"></i><span class="pl-1"><?php echo $profileData->location; ?></span></span>
                            </div>
                            <?php } ?>
                            <div class="userJoinedIn"><span><i class="fa fa-calendar" aria-hidden="true"></i><span class="pl-1">Joined <?php echo $loadFromUser->joinDate($profileData->joind_at); ?></span></span>
                            </div>
                        </div>
                ...
                <div class="dropdown-menu" style="box-shadow: 0px 0px 5px grey;">
                    ...
                    <?php } ?> 
                        ...
                        foreach($showTrend as $trend){ 
                            ...
                            ?>
                        <li>
                                <div class="hash-headline" style="font-size: 18px;font-weight:600;color: #2383c4;"> <a href="<?php echo BASE_URL.'trend.php?trend='.$trend->hashtag; ?>" style="color: #23aec4;">#<?php echo $trend->hashtag; ?></a></div>
