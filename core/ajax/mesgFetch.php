...
if(isset($_POST['loadUserid'])){
    ...
    foreach($allusers as $user){ 
     ...
     if (in_array($user->userId, $usersArr)) {
}else{
    array_push($usersArr,$user->userId);
...
<li class="msg-user-name-wrap align-middle" data-profileid=" <?php echo $user-> user_id; ?> ">
    ...
    <div class="msg-date-setting">
        <div class="msg-setting" style="color:#18d26e;display: flex;justify-content: center;align-items: center;">
...
if(isset($_POST['deleteMsg'])){
    ...
    $userid = $_POST['useridd'];
     $loadFromUser->delete('messages', array('messageID'=>$deleteMsg, 'messageFrom' => $userid));
